...
<div id="home-header-img">
    <div class="home-header-coments">
        <p class="home-header-title">短期間で<br />お金の教養を身につける</p>
        <div class="comment">
        ...
        <div class="home-header-performance">
            <div class="home-header-performance-wrap">
                ...
                <div
                    class="home-header-performance-card boder-r padding-center"
                >
                    <div class="home-header-performance-card-title">
...
<div id="four-features-field">
    ...
    <div class="card-wrap">
        <div class="card">
            ...
            <div class="comment">
                <p>
                    プロのファイナンシャルコンサルタントがマンツーマンであなたをサポートします、
                    お金に関する知識はもちろん、目標設定、最適な学習方法の提案、モチベーションの維持
                    などをサポートし、受講後も継続できるように習慣化することが可能です。
                </p>
            </div>
        </div>
        <div class="card">
            ...
            <div class="comment">
                <p>
                    ファイナンシャルコンサルタントがあなたの状況を分析し、あなたのためだけのカリキュラムを提供します。
                    これにより、必要なこと、興味があることに集中して学習することができます。
                </p>
            </div>
        </div>
        <div class="card">
            ...
            <div class="comment">
                <p>
                    一般的なお金のことを相談できる相手は限られます。CashAcademyでは、わからない所は「すぐに」「何回でも」相談可能です。
                </p>
            </div>
        </div>
        <div class="card">
            ...
            <div class="comment">
                <p>
                    お客様に寄り添ったサービスを提供しています。そのため。保険や不動産、投資信託などの金融商品を販売営業するようなことは一切ないのでご安心ください。
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="learning-curriculum-example-wrap">
            ...
            <div id="responsive-card-field">
                ...
                <div class="card">
                    ...
                    <div class="content">
                        <p>
                            インフレ・デフレの仕組み、お金の変遷と今後、お金の心理学など、知っておくことでお金について考えるための土台を学びます。
                        </p>
                    </div>
                </div>
            </div>
...
<div id="questionnaire-field">
    ...
    <div class="questionnaire-field-wrap">
        <div class="questionnaire-card">
            ...
            <div class="research-day"><p>※2021年4月時点での自社調べ</p></div>
        </div>
...
<div id="question-field">
    ...
    <div class="question-answer">
        ...
        <p class="answer">
            CashAcademyを受けた方の多くはお金の勉強については初心者です。初めて勉強する方でも理解できるようになっておりますのでご安心ください。
        </p>
    </div>
    ...
    <div class="question-answer">
        ...
        <p class="answer">
            ...
            マンツーマンで、かつお客様に現状分析を元にお話しするので、多くのお客様に「受けてよかった」という声をいただいております。
        </p>
    </div>
